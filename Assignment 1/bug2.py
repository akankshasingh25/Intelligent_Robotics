...
while robot.step(TIME_STEP) != -1:
    ...
    if state == 'start':
        ...
        on_line_again = on_line(current_position, start_position, GOAL_POSITION, tolerance= REACHED_GOAL)
        not_hit_point = distance_between(current_position, hit_point) > 1.5*REACHED_GOAL
